...
class ResetPasswordNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        .$notifiable->getEmailForPasswordReset().', haz clic en el botón que aparece a continuación para restablecer tu contraseña.'))
        ...
        ->line(Lang::get('Si no realizaste esta petición, ignora este mensaje.'))
